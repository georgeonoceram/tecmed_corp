    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_for', models.IntegerField(db_comment='Código do Fornecedor', verbose_name='Cód.Fornecedor')),
            ...
            options={
                'indexes': [models.Index(fields=['cod_for', 'seq_for'], name='tm_global_f_cod_for_a21c66_idx')],
            },
        ),
        migrations.CreateModel(
            name='Empresas',
            ...
            options={
                'indexes': [models.Index(fields=['cod_empresa', 'cod_filial'], name='tm_global_e_cod_emp_d80f4a_idx')],
            },
        ),
        migrations.CreateModel(
            name='Clientes',
            fields=[
                ...
                ('cod_cli', models.IntegerField(db_comment='Código do Cliente', verbose_name='Cód.Cliente')),
                ('seq_cli', models.IntegerField(db_comment='Sequencia do Cliente caso haja mais de um CNPJ', verbose_name='Seq.Cliente')),
            ...
            options={
                'indexes': [models.Index(fields=['cod_cli', 'seq_cli'], name='tm_global_c_cod_cli_890655_idx')],
            },
        ),
        migrations.CreateModel(
            name='Users',
            fields=[
                ...
                ('usr_mat', models.CharField(db_comment='Matrícula do Colaborador da empresa', max_length=1, verbose_name='Matrícula do Colaborador')),
